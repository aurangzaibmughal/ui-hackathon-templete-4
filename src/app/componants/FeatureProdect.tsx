...
const FeaturedProducts = () => {
  ...
  return (
    <section className="bg-purple-300 py-10 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product, index) => (
            ...
            >
              ...
              {/* Hover overlay */}
              <div className=" text-white opacity-0 hover:opacity-100 flex items-center justify-center rounded-xl transition duration-300">

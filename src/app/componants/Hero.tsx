...
//   return (
//     <section className="relative bg-gray-50 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
//       {/* Left Column: Lamp */}
//       <div className="md:w-1/4 flex justify-center items-start relative">
//         <div className="absolute top-[350px] left-[40px] z-10">
//           <Image src={current.lampImage} alt="Lamp" width={387} // Fixed size for lamp
//             height={387} // Fixed size for lamp
//           className="object-contain"
//           />
//         </div>

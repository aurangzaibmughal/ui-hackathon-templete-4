...
const LatestProduct = () => {
  // Dummy product data
  const products = [
    { id: 1, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest1.png", isSale: false },
    { id: 2, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest2.png", isSale: true },
    { id: 3, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latst3.png", isSale: false },
    { id: 4, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest4.png", isSale: false },
    { id: 5, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest5.png", isSale: false },
    { id: 6, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest6.png", isSale: false },
  ];
